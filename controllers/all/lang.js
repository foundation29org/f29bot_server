...
/**
 * @api {get} https://storias.org/api/langs/ Get languages
 * @apiName getLangs
 * @apiDescription This method return the languages available in Storias. you get a list of languages, and for each one you have the name and the code.
 ...
 *   this.http.get('https://storias.org/api/langs)
 *    .subscribe( (res : any) => {
